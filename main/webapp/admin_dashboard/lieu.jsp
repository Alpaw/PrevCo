...
%>
  ...
  <link rel="stylesheet" type="text/css" href="//netdna.bootstrapcdn.com/font-awesome/4.1.0/css/font-awesome.min.css">
    ...
    <link rel="stylesheet" href="<%= request.getContextPath() %>/admin_dashboard/style.css">
...
<header class="page-header">
  <nav>
    ...
    <ul class="admin-menu">
      ...
      <li>
        <a href="<%=request.getContextPath() %>/admin_dashboard/covid.jsp">
          <svg>
            <use xlink:href="#pages"></use>
          </svg>
          <span>Cas de covid</span>
        </a>
      </li>
      <li>
      ...
      <li>
        <a href="<%=request.getContextPath() %>/admin_dashboard/activite.jsp">
          <svg>
      ...
      <li>
        <a href="<%=request.getContextPath() %>/admin_dashboard/notification.jsp">
          <svg>
                        ...
                        <table class="table user-list">
                            <thead>
                                ...
                                <th class="text-center"><span>Ville</span></th>
                                                                <th><span>Latitude Longitude</span></th>
                            ...
                            ArrayList<VilleBean> list = sql.getAllLieu();
                            UserBean user=(UserBean) session.getAttribute("current_user");
                            int cpt=0;
                            for(VilleBean v: list){                            	
                            	...
                            	out.print(
                                        ...
                                        "<td>"+
                                            ...
                                            "<a class='user-link'>"+v.getNom()+"</a><br>"+
                                        "</td>"+
                                        "<td>"+v.getAdresse()+"</td>"+
                                        "<td class='text-center'>"+
                                            "<span class='label label-default'>"+v.getVille()+"</span>"+
                                        "</td>"+
                                        "<td>"+
                                            "<a >"+v.getLatitude()+" "+v.getLongitude()+"</a>"+
                                        "</td>"+
                                        "<td style='width: 20%;'>"+
                                        
											"<form method='post' action='"+ request.getContextPath() +"/SupprimerLieu' >"+
											"<input type='hidden' value='"+v.getId()+"' name='idToDelete' > </input> "+
