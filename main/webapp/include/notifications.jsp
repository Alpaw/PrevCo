												...
												for (UserBean user : sql.getAllUsers()){
													if (user.getId()==nb.getSendBy()){
														...
														if (userSend != null){
															if (nb.getType()==1){ // cas d'une requete d'amitie
																...
																if (sql.getFriendship(u.getId(), userSend.getId())!=2){ // si la notification est envoyé par un utilisateur qui n'est pas ami avec l'utilisateur connecté
																	out.print(" <h6><b>Friend Request</b></h6>"
																			...
																			+"<form method='post' action='"+ request.getContextPath() +"/ConfirmNotifFriendServlet' id='confirm" +userSend.getId()+"'>"+
																			"<input type='hidden'" +" value='"+u.getId()+"' name='id1' "+"></input>"+
																			"<input type='hidden'" +" value='"+userSend.getId()+"' name='id2' "+"></input>"+
																			"<input type='hidden'" +" value='"+nb.getAutoId()+"' name='autoId' "+"></input>"+
															...
															if (nb.getType()==4){ // un ami a le covid
																if (sql.getFriendship(u.getId(), userSend.getId())==2 ){
																	out.print(" <h6 ><b>Covid Alert !</b></h6>"
																			+"<p style=\'color:red;\'> Your friend "+userSend.getPrenom()+ " is positive to Covid !</p>");
