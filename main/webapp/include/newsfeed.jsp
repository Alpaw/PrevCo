...
<div class="theme-layout">
	...
	<div class="responsive-header">
		<div class="mh-head first Sticky">
			...
			<span class="mh-text">
				<a href="newsfeed.html" title=""><img src="<%= request.getContextPath() %>/template/images/logo2.png" alt=""></a>
			</span>
	...
	<div class="topbar stick">
		<div class="logo">
			<a title="" href="newsfeed.jsp"><img src="<%= request.getContextPath() %>/template/images/logo.png" alt=""></a>
		</div>
		...
		<div class="top-area">
						...
						<ul class="drops-menu">
							<li>
								<a href="notifications.html" title="">
									<img src="<%= request.getContextPath() %>/template/images/resources/thumb-1.jpg" alt="">
									<div class="mesg-meta">
										<h6>sarah Loren</h6>
							...
							<li>
								<a href="notifications.html" title="">
									<img src="<%= request.getContextPath() %>/template/images/resources/thumb-2.jpg" alt="">
									<div class="mesg-meta">
										<h6>Jhon doe</h6>
										<span>Hi, how r u dear ...?</span>
										<i>2 min ago</i>
							...
							<li>
								<a href="notifications.html" title="">
									<img src="<%= request.getContextPath() %>/template/images/resources/thumb-3.jpg" alt="">
									<div class="mesg-meta">
										<h6>Andrew</h6>
										<span>Hi, how r u dear ...?</span>
										<i>2 min ago</i>
							...
							<li>
								<a href="notifications.html" title="">
									<img src="<%= request.getContextPath() %>/template/images/resources/thumb-4.jpg" alt="">
									<div class="mesg-meta">
										<h6>Tom cruse</h6>
										<span>Hi, how r u dear ...?</span>
										<i>2 min ago</i>
							...
							<li>
								<a href="notifications.html" title="">
									<img src="<%= request.getContextPath() %>/template/images/resources/thumb-5.jpg" alt="">
									<div class="mesg-meta">
										<h6>Amy</h6>
										<span>Hi, how r u dear ...?</span>
										<i>2 min ago</i>
			...
			<div class="user-img">
				<img src="<%= request.getContextPath() %>/template/images/resources/admin.jpg" alt="">
							...
							<div class="col-lg-3">
								<aside class="sidebar static">
									...
									<div class="widget stick-widget">
										...
										<ul class="followers">
											<li>
												<figure><img src="<%= request.getContextPath() %>/template/images/resources/friend-avatar2.jpg" alt=""></figure>
											...
											<li>
												<figure><img src="<%= request.getContextPath() %>/template/images/resources/friend-avatar4.jpg" alt=""></figure>
												<div class="friend-meta">
											...
											<li>
												<figure><img src="<%= request.getContextPath() %>/template/images/resources/friend-avatar6.jpg" alt=""></figure>
												<div class="friend-meta">
											...
											<li>
												<figure><img src="<%= request.getContextPath() %>/template/images/resources/friend-avatar8.jpg" alt=""></figure>
												<div class="friend-meta">
											...
											<li>
												<figure><img src="<%= request.getContextPath() %>/template/images/resources/friend-avatar3.jpg" alt=""></figure>
												<div class="friend-meta">
							...
							<div class="col-lg-6">
								<div class="central-meta">
									<div class="new-postbox">
										<figure>
											<img src="<%= request.getContextPath() %>/template/images/resources/admin2.jpg" alt="">
										</figure>
								...
								<div class="central-meta item">
									<div class="user-post">
										<div class="friend-info">
											<figure>
												<img src="<%= request.getContextPath() %>/template/images/resources/friend-avatar10.jpg" alt="">
											</figure>
											...
											<ul class="we-comet">
												<li>
													<div class="comet-avatar">
														<img src="<%= request.getContextPath() %>/template/images/resources/comet-1.jpg" alt="">
													</div>
													...
													<ul>
														<li>
															<div class="comet-avatar">
																<img src="<%= request.getContextPath() %>/template/images/resources/comet-2.jpg" alt="">
															</div>
															<div class="we-comment">
																<div class="coment-head">
														...
														<li>
															<div class="comet-avatar">
																<img src="<%= request.getContextPath() %>/template/images/resources/comet-3.jpg" alt="">
															</div>
															<div class="we-comment">
																<div class="coment-head">
								...
								<div class="central-meta item">
									<div class="user-post">
										<div class="friend-info">
											<figure>
												<img src="<%= request.getContextPath() %>/template/images/resources/nearly1.jpg" alt="">
											</figure>
											<div class="friend-name">
								...
								<div class="central-meta item">
									<div class="user-post">
										<div class="friend-info">
											<figure>
												<img src="<%= request.getContextPath() %>/template/images/resources/nearly6.jpg" alt="">
											</figure>
											<div class="friend-name">
								...
								<div class="central-meta item">
									<div class="user-post">
										<div class="friend-info">
											<figure>
												<img alt="" src="<%= request.getContextPath() %>/template/images/resources/friend-avatar10.jpg">
											</figure>
											<div class="friend-name">
											...
											<div class="post-meta">
												<div class="linked-image align-left">
													<a title="" href="#"><img alt="" src="<%= request.getContextPath() %>/template/images/resources/page1.jpg"></a>
												</div>
												<div class="detail">
							...
							<div class="col-lg-3">
								<aside class="sidebar static">
									<div class="widget">
										...
										<div class="your-page">
											<figure>
												<a href="#" title=""><img src="<%= request.getContextPath() %>/template/images/resources/friend-avatar9.jpg" alt=""></a>
											</figure>
											<div class="page-meta">
													...
													<span><i class="ti-heart"></i>884</span>
													  ...
													  <div class="users-thumb-list">
														<a href="#" title="Anderw" data-toggle="tooltip">
															<img src="<%= request.getContextPath() %>/template/images/resources/userlist-1.jpg" alt="">  
														</a>
														<a href="#" title="frank" data-toggle="tooltip">
															<img src="<%= request.getContextPath() %>/template/images/resources/userlist-2.jpg" alt="">  
														</a>
														<a href="#" title="Sara" data-toggle="tooltip">
															<img src="<%= request.getContextPath() %>/template/images/resources/userlist-3.jpg" alt="">  
														</a>
														<a href="#" title="Amy" data-toggle="tooltip">
															<img src="<%= request.getContextPath() %>/template/images/resources/userlist-4.jpg" alt="">  
														</a>
														<a href="#" title="Ema" data-toggle="tooltip">
															<img src="<%= request.getContextPath() %>/template/images/resources/userlist-5.jpg" alt="">  
														</a>
														<a href="#" title="Sophie" data-toggle="tooltip">
															<img src="<%= request.getContextPath() %>/template/images/resources/userlist-6.jpg" alt="">  
														</a>
														<a href="#" title="Maria" data-toggle="tooltip">
															<img src="<%= request.getContextPath() %>/template/images/resources/userlist-7.jpg" alt="">  
														</a>  
													  </div>
												  </div>
									...
									<div class="widget">
										<div class="banner medium-opacity bluesh">
											<div class="bg-image" style="background-image: url(<%= request.getContextPath() %>/template/images/resources/baner-widgetbg.jpg)"></div>
											<div class="baner-top">
												<span><img alt="" src="<%= request.getContextPath() %>/template/images/book-icon.png"></span>
									...
									<div class="widget friend-list stick-widget">
										...
										<ul id="people-list" class="friendz-list">
											<li>
												<figure>
													<img src="<%= request.getContextPath() %>/template/images/resources/friend-avatar.jpg" alt="">
													<span class="status f-online"></span>
												</figure>
											...
											<li>
												<figure>
													<img src="<%= request.getContextPath() %>/template/images/resources/friend-avatar2.jpg" alt="">
											...
											<li>
												<figure>
													<img src="<%= request.getContextPath() %>/template/images/resources/friend-avatar3.jpg" alt="">
											...
											<li>
												<figure>
													<img src="<%= request.getContextPath() %>/template/images/resources/friend-avatar4.jpg" alt="">
													<span class="status f-off"></span>
												</figure>
												<div class="friendz-meta">
											...
											<li>
												...
												<figure>
													<img src="<%= request.getContextPath() %>/template/images/resources/friend-avatar5.jpg" alt="">
													<span class="status f-online"></span>
												</figure>
												<div class="friendz-meta">
											...
											<li>
												...
												<figure>
													<img src="<%= request.getContextPath() %>/template/images/resources/friend-avatar6.jpg" alt="">
													<span class="status f-away"></span>
												</figure>
												<div class="friendz-meta">
											...
											<li>
												...
												<figure>
													<img src="<%= request.getContextPath() %>/template/images/resources/friend-avatar7.jpg" alt="">
													<span class="status f-off"></span>
												</figure>
												<div class="friendz-meta">
										...
										<div class="chat-box">
											...
											<div class="chat-list">
												<ul>
													<li class="me">
														<div class="chat-thumb"><img src="<%= request.getContextPath() %>/template/images/resources/chatlist1.jpg" alt=""></div>
													...
													<li class="you">
														<div class="chat-thumb"><img src="<%= request.getContextPath() %>/template/images/resources/chatlist2.jpg" alt=""></div>
														<div class="notification-event">
															<span class="chat-message-item">
																Hi James! Please remember to buy the food for tomorrow! I’m gonna be handling the gifts and Jake’s gonna get the drinks
															</span>
			...
			<div class="row">
				<div class="col-lg-4 col-md-4">
					<div class="widget">
						<div class="foot-logo">
							<div class="logo">
								<a href="index-2.html" title=""><img src="<%= request.getContextPath() %>/template/images/logo.png" alt=""></a>
							</div>	
							<p>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					...
					<i><img src="<%= request.getContextPath() %>/template/images/credit-cards.png" alt=""></i>
				</div>
			</div>
		</div>
	</div>
