						...
						<div class="col-lg-10 col-sm-9">
							<div class="timeline-info">
								<ul>
									...
									<li><a class="active" href="time-line.html" title=""
								...
								<div class="col-lg-3">
									<aside class="sidebar static">
										<div class="widget">
											...
											<ul class="socials">
												<li class="facebook"><a title="" href="#"><i
														class="fa fa-facebook"></i> <span>facebook</span> <ins>45
															likes</ins></a></li>
												<li class="twitter"><a title="" href="#"><i
														class="fa fa-twitter"></i> <span>twitter</span> <ins>25
															likes</ins></a></li>
												<li class="google"><a title="" href="#"><i
														class="fa fa-google"></i> <span>google</span> <ins>35
															likes</ins></a></li>
											</ul>
										</div>
										<div class="widget">
												...
												<li>
													<div class="activity-meta">
														<i>30 Days Ago</i> <span><a href="newsfeed.html"
															title="">Posted your status. “Hello guys, how are
																you?”</a></span>
													</div>
												</li>
												<li>
												...
												<div class="friend-info">
													...
													<div class="post-meta">
														<div class="linked-image align-left">
															<a href="#" title=""><img
																src="<%= request.getContextPath() %>/template/images/resources/page1.jpg"
																alt=""></a>
														</div>
														<div class="detail">
										...
										<div class="central-meta item">
											<div class="user-post">
												<div class="friend-info">
													...
													<div class="post-meta">
														<img
															src="<%= request.getContextPath() %>/template/images/resources/user-post.jpg"
															alt="">
														<div class="we-video-info">
															<ul>
									...
									<aside class="sidebar static">
										<div class="widget">
											<div class="banner medium-opacity bluesh">
												...
												<div class="baner-top">
													<span><img
														src="<%= request.getContextPath() %>/template/images/book-icon.png"
														alt=""></span> <i class="fa fa-ellipsis-h"></i>
												</div>
												<div class="banermeta">
													<p>create your own favourit page.</p>
													<span>like them all</span> <a href="#" title=""
														data-ripple="">start now!</a>
												</div>
											</div>
										</div>
