...
<div class="theme-layout">
	...
	<div class="topbar stick">
		<div class="logo">
			<a title="" href="newsfeed.html"><img src="<%= request.getContextPath() %>/template/images/logo.png" alt=""></a>
		</div>
	...
	<section>
		<div class="feature-photo">
			<figure><img src="<%= request.getContextPath() %>/template/images/resources/timeline-1.jpg" alt=""></figure>
			<div class="add-btn">
				...
				<div class="row merged">
					<div class="col-lg-2 col-sm-3">
						<div class="user-avatar">
							<figure>
								<img src="<%= request.getContextPath() %>/template/images/resources/user-avatar.jpg" alt="">
								<form class="edit-phto">
									<i class="fa fa-camera-retro"></i>
									<label class="fileContainer">
										Edit Display Photo
						...
						<div class="timeline-info">
							<ul>
								<li class="">
								  ...
								  <h5><% UserBean uToShow=(UserBean) session.getAttribute("friend_to_show");
										if(uToShow!=null){
											...
											<div class="friend-info">
												...
												<div class="post-meta">
													<div class="linked-image align-left">
														<a href="#" title=""><img src="<%= request.getContextPath() %>/template/images/resources/page1.jpg" alt=""></a>
													</div>
													<div class="detail">
									...
									<div class="central-meta item">
										<div class="user-post">
											<div class="friend-info">
												...
												<div class="post-meta">
													<img src="<%= request.getContextPath() %>/template/images/resources/user-post.jpg" alt="">
													<div class="we-video-info">
														<ul>
								...
								<aside class="sidebar static">
									<div class="widget">
										<div class="banner medium-opacity bluesh">
											...
											<div class="baner-top">
												<span><img src="<%= request.getContextPath() %>/template/images/book-icon.png" alt=""></span>
