	...
	<div class="theme-layout">
		...
		<div class="topbar stick">
			...
			<div class="top-area">
				...
				<div class="user-img">
					<img src="images/resources/admin.jpg" alt=""> <span
		...
		<section>
			<div class="feature-photo">
				<figure>
					<img
						src="<%= request.getContextPath() %>/template/images/resources/timeline-1.jpg"
						alt="">
				</figure>
				<div class="add-btn">
					...
					<div class="row merged">
						<div class="col-lg-2 col-sm-3">
							<div class="user-avatar">
								<figure>
									<img
										src="<%= request.getContextPath() %>/template/images/resources/user-avatar.jpg"
										alt="">
									<form class="edit-phto">
							...
							<div class="timeline-info">
								<ul>
									...
									<li><a class="" href="time-line.html" title=""
										...
										href="timeline-photos.html" title="" data-ripple="">Photos</a>
										<a class="" href="timeline-videos.html" title=""
										data-ripple="">Videos</a> <a class="active"
										href="timeline-friends.html" title="" data-ripple="">Friends</a>
										<a class="" href="timeline-groups.html" title=""
										data-ripple="">Groups</a> <a class="" href="about.html"
										title="" data-ripple="">about</a> <a class="" href="#"
										title="" data-ripple="">more</a></li>
								</ul>
							</div>
						</div>
					</div>
									...
									<aside class="sidebar static">
										...
										<div class="widget stick-widget">
											...
											<ul class="short-profile">
												<li><span>about</span>
													<p>Hi, i am jhon kates, i am 32 years old and worked as
														a web developer in microsoft company.</p></li>
										...
										<div class="frnds">
											<ul class="nav nav-tabs">
												<li class="nav-item"><a class="active" href="#frends"
													data-toggle="tab">My Friends</a> <span> <%
											 ...
											 %>
												...
												<li class="nav-item"><a class="" href="#frends-req"
													data-toggle="tab">Friend request</a> <span> <%
