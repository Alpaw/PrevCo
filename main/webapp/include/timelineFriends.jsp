								...
								<div class="central-meta">
									<div class="frnds">
										<ul class="nav nav-tabs">
											 ...
											 %></span></li>
											 <li class="nav-item"><a class="" href="#frends-req" data-toggle="tab">Friend request</a>
											 <span><%
...
//											System.out.println("Je vais afficher les amis de : "+u.getId());
											...
											for(Friend f : list){
												...
												out.print(" <li>"+
														...
														"<figure>"+
															"<a href='time-line.html' title=''><img src=' "+request.getContextPath() +"/template/images/resources/friend-avatar9.jpg' alt=''></a>"+
														"</figure>"+
														"<div class='pepl-info'>"+
																"<form method='post' action='"+ request.getContextPath() +"/AffichageAmi' id='show" +f.getId()+"'>"+

															"<h4> <input type='submit' href='time-line.html' title='' value='"+ f.getNom()+" "+f.getPrenom()+"' ></input>"
											...
											for(Friend f : sql.getFriendsRequest(u.getId())){
												...
												out.print(" <li>"+
														...
														"<div class='pepl-info'>"+
															...
															"<h4> <input type='submit' href='time-line.html' title='' value='"+ f.getNom()+" "+f.getPrenom()+"' ></input>"
																	+"<input type='hidden' name='idToShow' value='"+ f.getId()+"'/>"
															+"</h4></form><br>"+																	"<h4><a href='time-line.html' title=''>"+"@"+f.getUsername()+" ("+f.getId()+")"+"</a></h4>"+
								...
								<aside class="sidebar static">
									...
									<div class="widget friend-list stick-widget">
										...
										"<div class='friendz-meta'>"+
											"<a href='time-line.html'>"+f.getPrenom()+" "+f.getNom()+"</a>"+
											"<i>@"+f.getUsername()+"</i>"+
										"</div>"+
									"</li>"
											);
