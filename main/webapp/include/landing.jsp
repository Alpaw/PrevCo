				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="land-featurearea">
						<div class="land-meta">
							<h1>PrevCo</h1>
							<p>
								Préviens tes copains, préviens du covid. <br> Sois
								connecté, reste en sécurité.
							</p>
						...
						<div class="log-reg-area sign">
							...
							<form method="post"
								...
								<div class="form-group">
									<input type="email" id="input" name="username"
										required="required"
										...
										class="control-label" for="input">Email</label><i
										class="mtrl-select"></i>
								</div>
								<div class="form-group">
							...
							<form method="post"
								...
								<div class="form-group">
									<input type="text" required="required" name="prenom"
										...
										value="<% if(request.getParameter("prenom")!=null) 
								...
								<div class="form-group">
									<input type="text" required="required" name="date"
										...
										value="<% if(request.getParameter("date")!=null)  out.print(request.getParameter("date")); %>"
										oninvalid="this.setCustomValidity('AAAA-MM-JJ')"
										oninput="this.setCustomValidity('')" /> <label
										class="control-label" for="input">Naissance
										(AAAA-MM-JJ)</label><i class="mtrl-select"></i>
								</div>
								...
								<div class="form-radio">
									<div class="radio">
										<label> <input type="radio" name="radio" value="M"
											<%
								  ...
								  %> /><i
									...
									<div class="radio">
										<label> <input type="radio" name="radio" value="F"
											<%
							  		if(request.getParameter("radio")!=null){
										 if(!request.getParameter("radio").equals("M")){
											  out.print("checked");
								...
								<div class="form-group">
									...
									<label class="control-label" for="input"><a
										...
										class="__cf_email__" data-cfemail="6c29010d05002c">[email&#160;protected]</a></label><i
										class="mtrl-select"></i>
