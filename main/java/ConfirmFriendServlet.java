...
/**
 * Servlet implementation class ConfirmFriend
 */
...
public class ConfirmFriendServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(u==null || request.getParameter("idToConfirm")==null) {
			...
			try{
				sql.confirmFriend(u.getId(),Integer.parseInt(request.getParameter("idToConfirm")) );
